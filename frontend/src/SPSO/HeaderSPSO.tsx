        ...
        >
            <div className=" flex items-center">
                <div className="space-x-7 flex items-center ">
                    ...
                    <button
                        type="button"
                        className={`size-10 flex justify-center items-center font-black px-1 rounded-full  ${isSidebarVisible ? 'bg-slate-300' : 'bg-white'} ${isSidebarVisible ? 'hover:scale-110' : 'hover:scale-110'}`}
                ...
                <div className="flex justify-center">
                    <p className="text-3xl font-bold" style={{ marginLeft: isSidebarVisible ? '240px' : '320px' }}>
                        Phần mềm in ấn thông minh
                    </p>
                </div>
            </div>
            <div className="justify-end items-center flex mr-8"></div>
        </div>
    );
}
