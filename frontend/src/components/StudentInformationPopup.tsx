...
export default function StudentInformationPopup({
    ...
    const fetchPrintHistory = async (user_ID: number) => {
        setLoading(true);
        try {
    ...
    useEffect(() => {
        fetchPrintHistory(student.user_ID);
    }, [student]);
        ...
        >
            ...
            >
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex justify-between text-lg">
                        <span className="font-semibold text-gray-700">MSSV:</span>
                        <span className="text-gray-600">{student.user_ID}</span>
                    </div>
                    <div className="flex justify-between text-lg">
                    ...
                    <div className="flex justify-between text-lg">
                        <span className="font-semibold text-gray-700">Số lần in:</span>
                        <span className="text-gray-600">{student.numOfPrint}</span>
                    </div>
                    <div className="flex justify-between text-lg">
                        <span className="font-semibold text-gray-700">Số trang còn lại:</span>
                        <span className="text-gray-600">{student.pageBalance}</span>
                    </div>
                </div>
                            ...
                            <table className="table-auto w-full bg-white">
                                <thead className="bg-[#C6DCFE]">
                                    <tr>
                                        ...
                                        <th className="px-4 py-2 text-center">Máy in</th>
