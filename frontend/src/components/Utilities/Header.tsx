    ...
    return (
        <div className="flex shadow border-2 w-full h-16 z-10 bg-white justify-between font-mono  ">
            <div className="space-x-7 flex">
                ...
                <button type="button" className="font-black hover:scale-110 px-1">
                    {' '}
                    Trang chủ{' '}
                </button>
                <button type="button" className="font-black hover:scale-110 px-1">
            ...
            <div className="flex items-center mt-2 mr-64">
                <button
                    type="button"
                    className="hover:scale-110 text-white bg-gradient-to-br from-green-400 to-blue-600 
                        hover:bg-gradient-to-bl focus:ring-4 
                        focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium 
                        rounded-lg text-xl px-5 py-2.5 text-center me-2 mb-2"
                >
                    In ngay
                </button>
            </div>
