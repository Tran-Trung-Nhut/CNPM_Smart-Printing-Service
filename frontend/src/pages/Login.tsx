...
export default function Login() {
    return (
        <div className="z-1 size-full drop-shadow-lg [background-image:linear-gradient(-90deg,_#6fb1fc,_#4364f7_50%,_#0052d4)]">
                                ...
                                <form className=" space-y-4">
                                    ...
                                    <p className="text-white text-sm !mt-8 text-center">
                                        ...
                                        <a
                                            ...
                                            className="text-white hover:underline ml-1 whitespace-nowrap font-semibold"
                                        >
                                            Đăng ký
                                        </a>
                                    </p>
