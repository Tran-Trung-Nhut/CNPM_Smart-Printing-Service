...
exports.createPrintConfig = async (req, res) => {
    try {
        const { printStart, printEnd, student_ID, printer_ID} = req.body;
        const postData = await PrintConfig.createPrintConfig(printStart, printEnd, student_ID, printer_ID);
...
exports.updatePrintConfig = async (req, res) => {
    try {
        ...
        const { printStart, printEnd, student_ID, printer_ID} = req.body;
        const updateData = await PrintConfig.updatePrintConfig(config_ID, printStart, printEnd, student_ID, printer_ID);
